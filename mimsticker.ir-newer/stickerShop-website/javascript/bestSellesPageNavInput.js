...
if (
  ...
  if (JSON.parse(localStorage.getItem("bestSellesCurrentPage")) == "1") {
    bestSellesPreviousPageBtn.style.background = "gray";
    bestSellesNextPageBtn.style.background = "#46a9e0";
  }
  if (JSON.parse(localStorage.getItem("bestSellesCurrentPage")) == "3") {
    bestSellesNextPageBtn.style.background = "gray";
    bestSellesPreviousPageBtn.style.background = "#46a9e0";
  }
  showBestSellPages();
} else {
